...
workflow COMPOMICS {
    ...
    CONVERT_PROFORMA ( PEPTIDESHAKER_REPORT.out.peptideshaker_peptide_file, PEPTIDESHAKER_REPORT.out.peptideshaker_protein_file, PEPTIDESHAKER_REPORT.out.peptideshaker_tsv_file_filtered )

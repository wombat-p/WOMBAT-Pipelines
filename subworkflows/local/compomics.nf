...
workflow COMPOMICS {
    ...
    CONVERT_PROFORMA ( PEPTIDESHAKER_REPORT.out.peptideshaker_tsv_file_filtered )
    FLASHLFQ ( CONVERT_PROFORMA.out.peptideshaker_proforma_file_filtered.collect(), RAW2MZML.out.collect(), parameters, exp_design )
